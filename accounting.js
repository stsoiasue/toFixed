...
(function(root, undefined) {
	 ...
	 * 
	 * Parameters:
	 * string		has "default positive format", must contact "%v"
	 * object		has `pos` (required, must contact "%v"), `neg`, `zero` properties
	 * function		returns a strin or object like above
	 * 
	 * Returns:
	 * object
	 *
	 */
	  ...
	  // B: Invalid string	==> use a default and turn it to an object if it's not already
	  // C: Valid object	==> leave object alone
	  // D: Invalid object	==> use a default and turn it to an object if it's not already
	  // E: Function		==> Depends on what the function returns
	  // F: Nothing			==> use a default and turn it to an object if it's not already
	...
	var toFixed = lib.toFixed = function(value, precision) {
		...
		var decimalPosition = roundedNum.length - precision;
		var returnNum = (roundedNum.slice(0, decimalPosition) + '.' + roundedNum.slice(decimalPosition)) * 1;

		return returnNum.toFixed(precision);
	};
